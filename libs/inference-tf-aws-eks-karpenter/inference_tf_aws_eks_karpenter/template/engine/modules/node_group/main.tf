...
resource "aws_launch_template" "this" {
  ...
  # Hop limit 1: blocks pods (one hop beyond the host) from reaching IMDS / the node
  # role via SSRF, while the host itself (hop 0) still bootstraps. See test_imds_blocked.
  metadata_options {
