...
| Autoscaling / Karpenter | `karpenter_version`, `cluster_autoscaler_chart_version`, `enable_gpu_p_nodepool`, `gpu_p_capacity_reservation_id`, `gpu_parallel_image_pull`, `gpu_parallel_image_pull_max_downloads`, `gpu_parallel_image_pull_layer_buffer_bytes`, `cpu_capacity`, `memory_capacity` |
